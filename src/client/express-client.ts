...
export class ExpressClient<API extends HttpInterface> {
	 ...
	 * as query parameters.
	 */
	public get<EP extends keyof API['get']>(endpoint: EP, args: API['get'][EP]['args'], config?: AxiosRequestConfig): AxiosPromise<API['get'][EP]['return']> {
	 ...
	 */
	public delete<EP extends keyof API['delete']>(endpoint: EP, args: API['delete'][EP]['args'], config?: AxiosRequestConfig): AxiosPromise<API['delete'][EP]['return']> {
		if (config === undefined) config = {};
		config.params = args;
	 ...
	 */
	public post<EP extends keyof API['post']>(endpoint: EP, args: API['post'][EP]['args'], config?: AxiosRequestConfig): AxiosPromise<API['post'][EP]['return']> {
	 ...
	 */
	public put<EP extends keyof API['put']>(endpoint: EP, args: API['put'][EP]['args'], config?: AxiosRequestConfig): AxiosPromise<API['put'][EP]['return']> {
	 ...
	 */
	public patch<EP extends keyof API['patch']>(endpoint: EP, args: API['patch'][EP]['args'], config?: AxiosRequestConfig): AxiosPromise<API['patch'][EP]['return']> {
